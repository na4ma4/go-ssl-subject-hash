...
func test_a() {
	testPrincipal := []byte{
		0x30, 0x39, 0x31, 0x0B, 0x30, 0x09, 0x06, 0x03, 0x55, 0x04, 0x06, 0x13, 0x02, 0x75, 0x73, 0x31, 0x0F, 0x30, 0x0D, 0x06, 0x03, 0x55, 0x04, 0x0A, 0x13, 0x06, 0x61, 0x6D, 0x61, 0x7A, 0x6F, 0x6E, 0x31, 0x19, 0x30, 0x17, 0x06, 0x03, 0x55, 0x04, 0x03, 0x13, 0x10, 0x61, 0x6D, 0x61, 0x7A, 0x6F, 0x6E, 0x20, 0x72, 0x6F, 0x6F, 0x74, 0x20, 0x63, 0x61, 0x20, 0x31,
	}
	testArray := [][]byte{
	...
	log.Printf("SubjectKeyId: %08x", sha1.Sum(cert.SubjectKeyId))
	log.Printf("subject.String(): %08x", sha1.Sum(cert.RawSubject))
